...
Load a saved model with `LightsclineCompute(evaluate_only=True)` rather than reconstructing the training dataset.

## Support

For the full product (optimization, self-training, custom loss, and more), contact [info@lightscline.com](mailto:info@lightscline.com).
